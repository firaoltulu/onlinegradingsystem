...
function doChange(){
	if (isset($_POST['change'])){
		if($_POST['first_name'] == "" OR $_POST['last_name'] == "" OR $_POST['middle_name'] == ""OR $_POST['email'] == "" 
		OR $_POST['pass'] == ""){
			message("Cannot live any field null!","error");
				redirect('index.php?view=prof');
		
		}
	
		elseif( $_POST['email'] !=  $_SESSION['EMAIL'] OR $_POST['pass'] != $_SESSION['PASSWORD'] ){
			$user = new User();
			$user->email =  $_POST['email'];
			$user->password = $_POST['pass'];
			$istrue =$user->update($_SESSION['ID']);
			if ($istrue == true){
			...
			if( $_POST['first_name'] != $_SESSION['FIRST_NAME'] OR $_POST['middle_name'] != $_SESSION['MIDDLE_NAME']
			OR $_POST['last_name'] != $_SESSION['LAST_NAME']){
				$tech = new Teacher();
				$tech->first_name	    = $_POST['first_name']	 ;
				$tech->middle_name       = $_POST['middle_name']  ;
				$tech->last_name	 	= $_POST['last_name'];

				$istrue =$tech->update($_SESSION['MEMBER_ID']);
				if ($istrue == true){
		...
		elseif( $_POST['first_name'] != $_SESSION['FIRST_NAME'] OR $_POST['middle_name'] != $_SESSION['MIDDLE_NAME']
		OR $_POST['last_name'] != $_SESSION['LAST_NAME']){
			$tech = new Teacher();
			$tech->first_name	    = $_POST['first_name']	 ;
			$tech->middle_name       = $_POST['middle_name']  ;
