		...
		<div class="container-login100" style="background-color : rgb(222,122,122); ">
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					Faculty Member Login Form
				</span>
				<form class="login100-form validate-form p-b-33 p-t-5" action="login.php" method="POST">

					<div class="wrap-input100 validate-input" data-validate = "Enter Your sign up Email">
						<input class="input100" type="text" name="uname" placeholder="Enter Email">
					...
					<div class="container-login100-form-btn m-t-55">
						<button class="btn btn-default m-2" name="btnlogin">
							Login
						</button>
					</div>
						<div class="container-login100-form-btn m-t-22">
						  <a href="signup.php" class="btn btn-link"><span ></span>Sign_in</a>
						</div>    
